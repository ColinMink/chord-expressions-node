...
Chord.prototype.generateNotes = function() {
    ...
    let quality = this.quality.extension ? triad.concat(extensions[this.quality.extension.value]) : triad;
...
Chord.prototype.generateName = function(){
    ...
    console.log("Interval.Notation.toText('#11')");
    console.log(Interval.Notation.toText('#11'));
...
let n = Chord.chordFromNotation("D(#11)");
console.log(n);
