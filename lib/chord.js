...
Chord.prototype.generateName = function(fromDB){
    const rootName = (fromDB && this.quality.triad.symbol == "m") ? this.dbRootName : this.rootNote.name;
...
Chord.prototype.extensionNameDB = function(str) {
...
Chord.prototype.extensionName = function(str, fromDB){
    console.log(str);
    console.log("str________________________________");
    if (fromDB) {return Chord.prototype.extensionNameDB(str)};
