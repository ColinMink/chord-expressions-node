...
Chord = function Chord(chord,notation) {
  this.rootNote = Note.fromName(chord.baseNote);
...
function chordFromNotation (notation){
  try {
...
exports.chordFromNotation = chordFromNotation;
/*
exports.chordFromNotation = function(notation){
  try {
  let parsedNotation = Parser.parse(notation);
  return new Chord(parsedNotation,notation);
  } catch (error) {
