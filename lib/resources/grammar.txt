...
Quality = arr:(Extension triad) {return {"extension": arr[0],"triad": arr[1]};} / 
...
triadWrapper = ("Maj" / "M" / "Δ") {return "major";}/("min"/"m"/"-"){return "m";} / ("+"/ "aug"){return "+";} / ("dim" / "o" / "°"){return "dim";} / ("ø" / "Ø") {return "ø";}/ "sus2" / "sus4" / "lyd" / "phryg" 
