...
extensionSymbol = ("maj" / "M") {return "maj"}
...
accInterval = head:requiredAccidentals tail:interval{
return head + tail;
}

accAdd = accInterval* / ws

modList = "(" start:(i:accInterval " "* "," " "* {return i;})* last:accInterval ")"{return start.concat(last)} / ws

addList = "(" " "* "add" " "* start:(i:accInterval " "* "," " "* {return i;})* last:accInterval ")"{return start.concat(last)} / ws
ws  = [\t\n\r]*
